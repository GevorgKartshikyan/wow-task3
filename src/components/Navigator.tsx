                ...
                <div className='container'>
                    <div className='nav'>
                        ...
                        <ul className='nav__block'>
                            <li className="nav__list"><a href="#" className="nav__link">Custom furniture production</a>
                            </li>
                            <li className="nav__list"><a href="" className="nav__link">Interior Design</a></li>
                            <Popup on='hover' mouseEnterDelay={200} mouseLeaveDelay={200} trigger={<div className="nav__list open">
                                ...
                                <div className='popupMenu'>
                                    ...
                                    <Popup
                                        ...
                                        trigger={
                                        <div>list3</div>
                                    } position='right top' mouseEnterDelay={200} mouseLeaveDelay={300}>
                                        <div className='popupMenu'>
                                            <div>list3-1</div>
                                            <div>list3-2</div>
                                            <div>list3-3</div>
